...
public class E2ESeleniumTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/*WebElement countryList = driver.findElement(By.cssSelector("#billing_country"));
		Select cL = new Select(countryList);
		cL.selectByVisibleText("");*/
		...
		//WebElement address = driver.findElement(By.xpa);
		...
		System.out.println(paymentMethod.size());
